							...
							<ul class="swatch__list is-flex"
								...
								foreach ( $terms as $term ) {
									...
									if ( $image ) {
                                        ...
                                        $item_image = 'swatch__list--item-image';
									} else {
									...
									if ( in_array( $term->slug, $options ) ) {
										...
										echo '<li data-variation="' . esc_attr( $term->slug ) . '" data-image-id="" class="swatch__list--item '. $item_image .' is-relative' . ( $term->slug == $selected ? ' is-selected' : '' ) . '">';

						...
						<tr class="saved-percent">
						   ...
						   <?php
								if ( $saved ) {
									foreach( $saved as $link_id => $val ){
							?>
									   <td data-link="<?php echo intval( $link_id ); ?>">
                                           <input data-price="<?php echo esc_html( $val['price'] ); ?>" name="wpa_wcpb[<?php echo intval( $link_id ); ?>][percent]" step="any" type="number" value="<?php echo esc_html( $val['percent'] ); ?>" />
                                           <input class = "hidden" name="wpa_wcpb[<?php echo intval( $link_id ); ?>][price]" type="text" value="<?php echo esc_html( $val['price'] ); ?>" />
                                       </td>
							<?php
									}
								}
